...
setwd ("/Users/laurabishop/Documents/Brooklyn Rolling Housing Sales")
bk <- read.csv("rollingsales_brooklyn.csv", header=TRUE, sep=',', skip=4)
...
#   as above "bk.sale"
bk.sale <- plot(log10(bk.homes$gross.sqft), log10(bk.homes$sale.price.n))
